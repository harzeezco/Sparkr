...
export default function Cursor() {
  ...
  const cursorSize = isHovered ? 100 : 10;
  ...
  const zIndexValue = isHovered ? 1000 : 1000;
  ...
  return (
    <div>
      <motion.div
        ...
        className={`${isLight} cursor grid items-center justify-center text-white`}
        ref={cursor}
      >
        {isHovered ? "Swipe" : null}
      </motion.div>
    </div>
  );
}
