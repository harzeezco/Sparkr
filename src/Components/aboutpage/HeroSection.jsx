...
const HeroSection = () => {
  ...
  return (
    <Container id="hero">
      <h1
        className={`whitespace-nowrap font-primary text-3xl font-bold capitalize leading-10 pt-12 text-${theme} theme-transition sm:text-[3.2rem] sm:leading-[60px] lg:text-[6.5vw] lg:leading-[90px]`}
      >
        Hello, We’re a <br />{" "}
      ...
      <div className="grid grid-cols-1 md:grid-cols-[30%_60%] justify-between mt-5 mb-10 gap-y-4">
        <h4 className={`text-${theme} font-bold md:text-xl leading-[30px] theme-transition`}>Professional Creative Design Agency Based in Bangladesh</h4>
